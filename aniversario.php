...
<html>
	<head>
		...
		<title> Piano Virtual - Happy Birthday </title>
	</head>

	<body>
		<style>
			body {
			  background-image: url("imagens/fofo.gif");
			}
		</style>

		<img id="birthday" src="imagens/birthday.jpg">
			...
			<center>
				...
				<div class="posicoes">
					...
					<div id="posicao_branco">
						...
						<input id="voltar1" type="submit" name="botao" value="VOLTAR"> 
					</div>
